...
class Basic_Auth():
    class Delete_Base(Generated_Class_Base):
        """Prompts the user for authentication using HTTP Basic Auth"""


        def __init__(self, request, resp_t=(False, [{'body': None, 'code': 401}, {'body': 'text/plain', 'code': 200}, {'body': None, 'code': 400}, {'body': None, 'code': 500}])):
            self.req = request
        ...
        def check_overriden(self):
            ...
            for method in ('auth_handler', 'validate_params_handler', '__init__', 'handle_request'):
                ...
                base_method = getattr(Basic_Auth.Delete_Base, method)
